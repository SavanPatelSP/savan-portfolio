...
const changelog: ChangelogEntry[] = [
  {
    ...
    added: [
      ...
      "Home page with hero, products, projects, and vision sections",
      "Products section covering the SP NET ecosystem and future roadmap",
      "Founder pages: about, journey, philosophy, and roadmap",
      "Projects gallery with filterable cards and detail views",
      "Blog with technical articles and product updates",
      "Documentation site with reference, application, and platform pages",
      "Trust and Status pages with transparent product status",
      "Contact form and get-in-touch page",
      "Frequently Asked Questions with categorized questions",
    ...
    fixed: [
      "Aligned roadmap milestones and product statuses with the actual state of development",
      "Removed unverified progress indicators from product cards",
      "Standardized version numbers across package.json and application config",
    ],
    knownIssues: [
    ...
    upgradeNotes: [
      "This is the initial public release of the current site — no previous version to upgrade from",
