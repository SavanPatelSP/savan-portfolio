  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Architecture", slug: "architecture/technology-stack", href: "/docs/architecture/technology-stack", description: "How the site is built" },
        { title: "Developer Guide", slug: "developer/project-setup", href: "/docs/developer/project-setup", description: "About the build" },
