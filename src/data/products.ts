export const products = [
  {
    ...
    tagline: "Private blockchain platform by SP NET INC",
    description:
      "A private blockchain platform by SP NET INC. SP NET BLOCKCHAIN is the long-term foundation for digital assets, official tokens, wallet infrastructure, and enterprise blockchain services — powering the next generation of the SP NET ecosystem.",
    status: "building",
    url: "/products/sp-net-blockchain",
    ...
    features: [
      "Private blockchain platform powering the entire SP NET ecosystem",
      "Official token infrastructure for SavaroX and future tokens",
      "Enterprise-grade wallet, explorer, and developer platform",
    ],
  },
  {
    id: "sp-net-gram",
