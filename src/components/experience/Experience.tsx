...
function TimelineMilestone({ item, index, isInView }: { item: typeof journey[number]; index: number; isInView: boolean }) {
      ...
      <div className="hidden lg:grid lg:grid-cols-2 lg:gap-8 items-center">
        ...
        <div className={cn("flex justify-center", isEven ? "order-1" : "order-1")}>
          <motion.div
            ...
            transition={{ delay: index * 0.12, duration: 0.3, type: "spring", stiffness: 200, damping: 15 }}
          >
      ...
      <div className="lg:hidden">
        ...
        >
          ...
          {index < journey.length - 1 && (
            <div className="absolute left-[15px] top-3 bottom-0 w-px bg-gradient-to-b from-blue-500/20 to-transparent" />
          )}

          <div className="absolute left-0 top-1">
            <div className="h-7 w-7 rounded-full border-2 border-blue-500/30 bg-black flex items-center justify-center">
